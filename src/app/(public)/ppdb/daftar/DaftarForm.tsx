        ...
        <div className="space-y-8">
            ...
            <form ref={formRef} action={formAction} className="bg-white rounded-[48px] shadow-2xl shadow-blue-900/5 border border-slate-100 overflow-hidden transition-all">
                <div className="p-8 lg:p-12">
                    {/* Step 1: Data Santri */}
                    <div className={`space-y-10 animate-fade-in ${step === 1 ? "block" : "hidden"}`} data-step="1">
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input name="namaLengkap" type="text" required={step === 1} placeholder="Contoh: Ahmad Fauzi" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Jenis Kelamin</label>
                                    <select name="jenisKelamin" required={step === 1} className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all appearance-none cursor-pointer">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input name="tempatLahir" type="text" required={step === 1} placeholder="Contoh: Deli Serdang" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Tanggal Lahir</label>
                                    <input name="tanggalLahir" type="date" required={step === 1} className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Sekolah Asal (SMP/MTs)</label>
                                    <input name="asalSekolah" type="text" required={step === 1} placeholder="Contoh: MTs Darul Ihsan" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                            </div>
                        </div>
                        <div className="pt-6 flex justify-end">
                            <button type="button" onClick={nextStep} className="px-10 py-4 bg-primary-container text-white rounded-2xl font-bold hover:bg-secondary transition-all shadow-xl shadow-blue-900/10 flex items-center gap-2">
                    ...
                    <div className={`space-y-10 animate-fade-in ${step === 2 ? "block" : "hidden"}`} data-step="2">
                        <div>
                            <div className="flex items-center gap-3 mb-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input name="namaAyah" type="text" required={step === 2} placeholder="Contoh: Abdullah" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Nama Ibu Kandung</label>
                                    <input name="namaIbu" type="text" required={step === 2} placeholder="Contoh: Fatimah" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Nomor WhatsApp Aktif</label>
                                    <input name="nomorWhatsapp" type="tel" required={step === 2} placeholder="Contoh: 081234567890" className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all" />
                                </div>
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Alamat Lengkap</label>
                                    <textarea name="alamat" required={step === 2} rows={3} placeholder="Dusun, Desa, Kecamatan, Kabupaten..." className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-secondary outline-none transition-all resize-none" />
                                </div>
                            </div>
                        </div>
                        <div className="pt-6 flex justify-between gap-4">
                            <button type="button" onClick={prevStep} className="px-8 py-4 bg-white border-2 border-slate-100 text-on-surface-variant rounded-2xl font-bold hover:bg-slate-50 transition-all flex items-center gap-2">
                    ...
                    <div className={`space-y-10 animate-fade-in ${step === 3 ? "block" : "hidden"}`} data-step="3">
                        <div>
                            <div className="flex items-center gap-3 mb-8">
                        ...
                        <div className="pt-6 flex justify-between gap-4">
                            <button type="button" onClick={prevStep} disabled={pending} className="px-8 py-4 bg-white border-2 border-slate-100 text-on-surface-variant rounded-2xl font-bold hover:bg-slate-50 transition-all flex items-center gap-2 disabled:opacity-50">
                                <span className="material-symbols-outlined">arrow_back</span>
                                Edit Data
                            </button>
                            <button 
